  ...
  return (
    <section ref={containerRef} className="relative h-screen bg-lux-dark overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img src="/images/unfinished_space_1778847108451.webp" alt="Unfinished Space" className="w-full h-full object-cover filter grayscale opacity-50" />
      ...
      >
        <img src="/images/curated_space_1778847129791.webp" alt="Curated Space" className="w-full h-full object-cover" />
